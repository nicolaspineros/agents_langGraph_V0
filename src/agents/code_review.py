...
class SecurityReview(BaseModel):
    """Review of the security of the code"""
    vulnerabilities: list[str] = Field(description="The vulnerabilities of the code", default_factory=None)
    riskLevel: str = Field(description="The risk level of the vulnerabilities", default=None)
    suggestions: list[str] = Field(description="The suggestions for fixing the vulnerabilities", default_factory=None)

class MaintainabilityReview(BaseModel):
    """Review of the maintainability of the code"""
    concerns: list[str] = Field(description="The concerns of the code", default_factory=None)
    qualityScore: int = Field(description="The quality score of the code from 1 to 10", default=None, ge=1, le=10)
    recommendations: list[str] = Field(description="The recommendations for improving the code", default_factory=None)
